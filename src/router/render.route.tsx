...
const withGuard = (
  ...
  if (path === PATH.PAGE.DASHBOARD) {
    ...
    return <RoleGuardRoute allowedRoles={[UserType.ADMIN, UserType.ROOT, UserType.MANAGER, UserType.EXECUTIVE, UserType.MARKETING, UserType.STAFF, UserType.STORAGEKEEPER]}>{node}</RoleGuardRoute>;
  }
